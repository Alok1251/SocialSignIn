...
public class activity_facebook_user_profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facebook_user_profile);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(activity_facebook_user_profile.this);
                builder_exitbutton.setTitle("You want to Logout ?")
                        ...
                        .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Toast.makeText(activity_facebook_user_profile.this, "Facebook Logged out successfully!", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(activity_facebook_user_profile.this, MainActivity.class);
